...
/**
 * Contains some constants describing the format of an actigraph file. Two formats exist so far:
 * <ul>
 * <li> {@link #EXPORTED} is the format of the actigraph file exported via the DataScoring details on
 * Actilife (see documentation).</li>
