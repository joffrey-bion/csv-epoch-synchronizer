...
/**
 * Contains the statistics on the breathing of the user over a short period of time. These values
 * are contained in one line in the K4b2 file.
 *
...
public class Sample {
    ...
    /**
     * The start time of this {@code Sample}, corresponding to the previous row's timestamp, in
     * milliseconds.
     */
    public long startTime;

    /**
     * The end time of this {@code Sample}, corresponding to this row's timestamp, in milliseconds.
     */
    public long endTime;
     ...
     * @param previousTime
     *            The timestamp of the previous row (in milliseconds), to be able to know the
     *            duration of this {@code Sample}.
