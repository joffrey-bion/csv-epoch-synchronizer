...
class TimeWindow {
    ...
    private final LinkedList<String[]> samples;

    private final EpochStatsLine stats;
    ...
    private static class EpochStatsLine extends StatsLineSkipSome {
        ...
        public String[] getEpochLine(long firstTimestamp) {
            final String[] timestamp = {DateHelper.toDateTimeMillis(firstTimestamp / 1000000)};
    ...
    private String[] removeFirst() {
        ...
        final String[] line = samples.removeFirst();
        stats.remove(line);
    ...
    public String[] accumulate(long phoneToActigDelay) {
        ...
        final String[] accLine = stats.getEpochLine(lastEpBeginning + phoneToActigDelay);
        return accLine;
    }
