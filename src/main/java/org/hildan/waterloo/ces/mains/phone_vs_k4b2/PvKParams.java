...
import org.hildan.utils.xml.serialization.serializers.DurationArraySerializer;
...
public class PvKParams extends Parameters {
     ...
     */
    public PvKParams(String paramsFilePath) throws IOException, SAXException, SpecificationNotMetException {
        super(SCHEMA);
    ...
    /**
     * Creates a new empty {@link PvKParams} object that has to be filled via {@link Parameters}'
    ...
    public void populatePublicFields() {
        ...
        final Long[] phoneSpikes = get(PHONE_SPIKES_LIST, PHONE_SER);
        final Long[] k4b2Spikes = get(K4B2_SPIKES_LIST, K4B2_SER);
