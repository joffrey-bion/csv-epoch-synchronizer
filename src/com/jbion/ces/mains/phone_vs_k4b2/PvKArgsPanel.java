...
class PvKArgsPanel extends JPanel {
    ...
    private void setParameters(PvKParams params) {
        ...
        inputs[PhoneVSK4b2.INPUT_PARTICIPANT].setSelectedFilePath(params
                .getString(PvKParams.PARTICIPANT_FILE));
        FilePicker[] outputs = filePickers.getOutputFilePickers();
        outputs[PhoneVSK4b2.OUTPUT_VALIDATION].setSelectedFilePath(params
                .getString(PvKParams.VALIDATION_FILE));
    ...
    /**
     * Fills the specified {@link PvKParams} object with the current fields of this
    ...
    public void getParameters(PvKParams params) throws ParseException {
        setFileParam(params, PvKParams.PHONE_FILE,
                filePickers.getInputFilePaths()[PhoneVSK4b2.INPUT_PHONE]);
        setFileParam(params, PvKParams.K4B2_FILE,
                filePickers.getInputFilePaths()[PhoneVSK4b2.INPUT_K4B2]);
        setFileParam(params, PvKParams.PARTICIPANT_FILE,
                filePickers.getInputFilePaths()[PhoneVSK4b2.INPUT_PARTICIPANT]);
        setFileParam(params, PvKParams.VALIDATION_FILE,
                filePickers.getOutputFilePaths()[PhoneVSK4b2.OUTPUT_VALIDATION]);
        ...
        if (nbSpikes > 0) {
            params.deserializeAndSet(PvKParams.PHONE_SPIKES_LIST,
                    Arrays.copyOfRange(phoneSpikes, 0, nbSpikes));
            params.deserializeAndSet(PvKParams.K4B2_SPIKES_LIST,
