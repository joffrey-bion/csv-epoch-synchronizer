...
public class PhoneVSK4b2 {
    ...
    private static HashMap<Phase, Accuracy> analyze(PvKParams params) throws IOException,
            SAXException, SpecificationNotMetException {
        ...
        new PrintableAccuracies(accuracies).writeResults(params.participantFile,
