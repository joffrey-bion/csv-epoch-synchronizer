...
public class OldPvAParams implements PhoneRawToEpParams {
    ...
    /**
     * Creates a {@code OldPvAParams} object based on the given raw parameters.
     * 
     * @param rawParams
     ...
     */
    public OldPvAParams(OldPvARawParams rawParams) throws ArgumentFormatException {
        ...
        try {
            startTime = DateHelper.timestampStrToNanos(rawParams.startTime,
                    OldPvAParams.START_STOP_TIMESTAMP_FORMAT);
