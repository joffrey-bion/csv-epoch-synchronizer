...
public class OldConfig {
     ...
     */
    public static OldConfig get() {
        if (instance == null) {
            instance = new OldConfig(getConfigFilePath());
        }
        return instance;
    }
    ...
    private OldConfig(String configFileName) {
    ...
    private static String getConfigFilePath() {
        try {
            String urlString = ClassLoader
                    ...
                    //.getResource("com/joffrey_bion/csv_epoch_synchronizer/mains/phone_vs_actigraph/PhoneVSActigraphMerger.class")
                    .getResource(OldConfig.class.getName().replace('.', '/') + ".class")
                    .toString();
